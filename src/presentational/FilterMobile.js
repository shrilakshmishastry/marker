...
const allCollection = (
  <svg
    ...
    height="16"
    fill="currentColor"
    className="bi bi-list-stars mt-1"
    viewBox="0 0 16 16"
  >
    <path
      fillRule="evenodd"
    ...
    <React.Fragment>
      ...
      >
        <button
          ...
          className="btn hideController rounded"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            fill="currentColor"
            className="hideControllerIcon bi bi-filter-circle"
            viewBox="0 0 16 16"
          >
      ...
      <div
        ...
        className={
          modalOpen
            ? `filterMobile-offcanvas_open`
            : `filterMobile-offcanvas_hide`
        }
        tabIndex={"-1"}
